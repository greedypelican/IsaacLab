...
* :obj:`SPOT_ARM_CFG`: The Spot robot with delay PD and remote PD actuators.
"""
...
SPOT_ARM_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="../Assets/Collected_spotarm/spotarm.usd",
    ...
    actuators={
        ...
        "spot_lowerarm": DelayedPDActuatorCfg(
            joint_names_expr=["arm0_sh0", "arm0_sh1", "arm0_el0"],
            effort_limit_sim=90,
            stiffness=60.0,
            damping=1.5,
            min_delay=0,  # physics time steps (min: 2.0*0=0.0ms)
        ...
        "spot_upperarm": DelayedPDActuatorCfg(
...
"""Configuration for the Boston Dynamics Spot Arm robot."""
