...
import isaaclab_tasks.manager_based.locomotion.velocity.config.spot_arm.mdp as spot_arm_mdp
...
# Pre-defined configs
##
from isaaclab_assets.robots.spot_arm import SPOT_ARM_CFG  # isort: skip
...
class SpotArmEventCfg:
    ...
    reset_robot_joints = EventTerm(
        func=spot_arm_mdp.reset_joints_around_default,
        mode="reset",
        params={
...
class SpotArmRewardsCfg:
    ...
    air_time = RewardTermCfg(
        func=spot_arm_mdp.air_time_reward,
        weight=5.0,
        params={
            "mode_time": 0.3,
    ...
    base_angular_velocity = RewardTermCfg(
        func=spot_arm_mdp.base_angular_velocity_reward,
        weight=5.0,
        params={"std": 2.0, "asset_cfg": SceneEntityCfg("robot")},
    )
    base_linear_velocity = RewardTermCfg(
        func=spot_arm_mdp.base_linear_velocity_reward,
        weight=5.0,
    ...
    # -- penalties
    action_smoothness = RewardTermCfg(func=spot_arm_mdp.action_smoothness_penalty, weight=-1.0)
    air_time_variance = RewardTermCfg(
        func=spot_arm_mdp.air_time_variance_penalty,
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_foot")},
    )
    base_motion = RewardTermCfg(
        func=spot_arm_mdp.base_motion_penalty, weight=-2.0, params={"asset_cfg": SceneEntityCfg("robot")}
    )
    base_orientation = RewardTermCfg(
        func=spot_arm_mdp.base_orientation_penalty, weight=-3.0, params={"asset_cfg": SceneEntityCfg("robot")}
    )
    foot_slip = RewardTermCfg(
        func=spot_arm_mdp.foot_slip_penalty,
        weight=-0.5,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_foot"),
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_foot"),
    ...
    joint_acc = RewardTermCfg(
        func=spot_arm_mdp.joint_acceleration_penalty,
        weight=-1.0e-4,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*_h[xy]")},
    )
    joint_pos = RewardTermCfg(
        func=spot_arm_mdp.joint_position_penalty,
        weight=-0.7,
        params={
    ...
    joint_torques = RewardTermCfg(
        func=spot_arm_mdp.joint_torques_penalty,
        weight=-5.0e-4,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*")},
    )
    joint_vel = RewardTermCfg(
        func=spot_arm_mdp.joint_velocity_penalty,
        weight=-1.0e-2,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*_h[xy]")},
    )
