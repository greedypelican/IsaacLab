...
SPOT_ARM_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/haryun/workspace/IsaacRobotics/assets/spot_arm.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            ".*_kn"   : -1.5,  # all knees
            "arm0_sh0": 0.0,
            "arm0_sh1": -3.1,  #-177.617
            "arm0_el0": 2.8,   #160.428
            "arm0_el1": 0.0,   #0
            "arm0_wr0": 0.3,   #17.189     
            "arm0_wr1": 0.0,   #0
            "arm0_f1x": 0.0,   #0
    ...
    actuators={
        ...
        "spot_shoulder": DelayedPDActuatorCfg(
            joint_names_expr=["arm0_sh1"],
            effort_limit_sim=181.8,
            stiffness=60.0,
            damping=1.5,
            min_delay=0,  # physics time steps (min: 2.0*0=0.0ms)
            max_delay=4,  # physics time steps (max: 2.0*4=8.0ms)
        ),
        "spot_elbow": DelayedPDActuatorCfg(
            joint_names_expr=["arm0_sh0", "arm0_el0"],
            effort_limit_sim=90.9,
            stiffness=60.0,
            damping=1.5,
            min_delay=0,  # physics time steps (min: 2.0*0=0.0ms)
            max_delay=4,  # physics time steps (max: 2.0*4=8.0ms)
        ),
        "spot_wrist": DelayedPDActuatorCfg(
            joint_names_expr=["arm0_el1", "arm0_wr0", "arm0_wr1"],
            effort_limit_sim=30.3,
            stiffness=60.0,
            damping=1.5,
            min_delay=0,  # physics time steps (min: 2.0*0=0.0ms)
            max_delay=4,  # physics time steps (max: 2.0*4=8.0ms)
        ),
        "spot_finger": DelayedPDActuatorCfg(
            joint_names_expr=["arm0_f1x"],
            effort_limit_sim=15.3,
            stiffness=60.0,
            damping=1.5,
            min_delay=0,  # physics time steps (min: 2.0*0=0.0ms)
            max_delay=4,  # physics time steps (max: 2.0*4=8.0ms)
