...
# Pre-defined configs
##
from isaaclab_assets.robots.kinovagen3n6 import KINOVAGEN3N6_CFG  # isort: skip
...
@configclass
class KinovaGen3N6PickAndPlaceEnvCfg(joint_pos_env_cfg.KinovaGen3N6PickAndPlaceEnvCfg):
...
@configclass
class FrankaTeddyBearPickAndPlaceEnvCfg(KinovaGen3N6PickAndPlaceEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
