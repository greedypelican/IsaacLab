...
def object_position_in_robot_root_frame(   # -> asset_position_in_robot_root_frame
...
def current_phase(
    ...
    Returns:
        ...
        0.0: pick phase (phase1_complete가 False)
        ...
        4.0: goback phase (phase4_complete가 True, phase5_complete가 False)
        5.0: ready phase (phase5_complete가 True)
    """
