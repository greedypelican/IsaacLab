...
import isaaclab_tasks.manager_based.manipulation.pickandplace.mdp as mdp
...
# Pre-defined configs
##
from isaaclab_assets.robots.lerobot import RIGHT_LEROBOT_CFG  # isort: skip
...
@configclass
class LeRobotHandOVerEnvCfg(joint_pos_env_cfg.LeRobotHandOVerEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot = RIGHT_LEROBOT_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.actions.arm_action = DifferentialInverseKinematicsActionCfg(
            ...
            body_offset=DifferentialInverseKinematicsActionCfg.OffsetCfg(pos=[0.15, 0.0, 0.0]),
        )
...
@configclass
class LeRobotTeddyBearHandOverEnvCfg(LeRobotHandOVerEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        # self.scene.robot.actuators["robotiq_85_left_knuckle_joint"].effort_limit_sim = 50.0
        # self.scene.robot.actuators["robotiq_85_left_knuckle_joint"].stiffness = 40.0
        # self.scene.robot.actuators["robotiq_85_left_knuckle_joint"].damping = 10.0
