...
from isaaclab_tasks.manager_based.locomotion.velocity.config.spot_arm.rough_env_cfg import SpotArmRoughEnvCfg_PLAY
...
def main():
    ...
    # setup environment
    env_cfg = SpotArmRoughEnvCfg_PLAY()
