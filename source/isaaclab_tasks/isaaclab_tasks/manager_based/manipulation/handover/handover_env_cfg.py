...
class SceneCfg(InteractiveSceneCfg):
    ...
    bowl: RigidObjectCfg | DeformableObjectCfg = MISSING
    ...
    contact_forces_right_arm: ContactSensorCfg = MISSING
    contact_forces_right_upper_gripper: ContactSensorCfg = MISSING
    contact_forces_right_lower_gripper: ContactSensorCfg = MISSING
    contact_forces_left_arm: ContactSensorCfg = MISSING
    contact_forces_left_upper_gripper: ContactSensorCfg = MISSING
    contact_forces_left_lower_gripper: ContactSensorCfg = MISSING
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        left_joint_pos = ObsTerm(func=mdp.joint_pos, params={"asset_cfg": SceneEntityCfg("left_robot")})
        left_joint_pos_rel = ObsTerm(func=mdp.joint_pos_rel, params={"asset_cfg": SceneEntityCfg("left_robot")})
        left_joint_vel = ObsTerm(func=mdp.joint_vel, params={"asset_cfg": SceneEntityCfg("left_robot")})
        left_joint_vel_rel = ObsTerm(func=mdp.joint_vel_rel, params={"asset_cfg": SceneEntityCfg("left_robot")})

        right_joint_pos = ObsTerm(func=mdp.joint_pos, params={"asset_cfg": SceneEntityCfg("right_robot")})
        right_joint_pos_rel = ObsTerm(func=mdp.joint_pos_rel, params={"asset_cfg": SceneEntityCfg("right_robot")})
        right_joint_vel = ObsTerm(func=mdp.joint_vel, params={"asset_cfg": SceneEntityCfg("right_robot")})
        right_joint_vel_rel = ObsTerm(func=mdp.joint_vel_rel, params={"asset_cfg": SceneEntityCfg("right_robot")})

        # right_object_position = ObsTerm(func=mdp.object_position_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("right_robot"), "object_cfg": SceneEntityCfg("object")}, noise=Unoise(n_min=-0.015, n_max=0.015))
        # right_object_orientation = ObsTerm(func=mdp.object_orientation_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("right_robot"), "object_cfg": SceneEntityCfg("object")}, noise=Unoise(n_min=-0.015, n_max=0.015))
        # left_object_position = ObsTerm(func=mdp.object_position_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("left_robot"), "object_cfg": SceneEntityCfg("object")}, noise=Unoise(n_min=-0.015, n_max=0.015))
        # left_object_orientation = ObsTerm(func=mdp.object_orientation_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("left_robot"), "object_cfg": SceneEntityCfg("object")}, noise=Unoise(n_min=-0.015, n_max=0.015))

        # right_bowl_position = ObsTerm(func=mdp.object_position_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("right_robot"), "object_cfg": SceneEntityCfg("bowl")}, noise=Unoise(n_min=-0.015, n_max=0.015))
        # right_bowl_orientation = ObsTerm(func=mdp.object_orientation_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("right_robot"), "object_cfg": SceneEntityCfg("bowl")}, noise=Unoise(n_min=-0.015, n_max=0.015))
        # left_bowl_position = ObsTerm(func=mdp.object_position_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("left_robot"), "object_cfg": SceneEntityCfg("bowl")}, noise=Unoise(n_min=-0.015, n_max=0.015))
        # left_bowl_orientation = ObsTerm(func=mdp.object_orientation_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("left_robot"), "object_cfg": SceneEntityCfg("bowl")}, noise=Unoise(n_min=-0.015, n_max=0.015))

        right_ee_frame_pose = ObsTerm(func=mdp.ee_frame_pose, params={"ee_frame_cfg": SceneEntityCfg("right_ee_frame")})
        left_ee_frame_pose = ObsTerm(func=mdp.ee_frame_pose, params={"ee_frame_cfg": SceneEntityCfg("left_ee_frame")})
